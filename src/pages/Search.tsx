  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <p className="section-label text-white/40 mb-2">SEARCH RESULTS</p>
        ...
        {!loading && movies.length > 0 && (
          <section className="mb-12">
            <p className="section-label text-blue-400 mb-2">MOVIES</p>
            <h2 className="text-xl font-black text-white mb-6">Movies & TV Shows</h2>
        ...
        {!loading && anime.length > 0 && (
          <section>
            ...
            <h2 className="text-xl font-black text-white mb-6">Anime</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
